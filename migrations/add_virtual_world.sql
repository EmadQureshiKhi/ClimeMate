...
-- Add virtual world features for gamification
...
CREATE TABLE IF NOT EXISTS achievements (
  ...
  icon TEXT NOT NULL,
  category TEXT NOT NULL, -- 'charging', 'social', 'environmental', 'gaming'
  requirement_type TEXT NOT NULL, -- 'sessions', 'kwh', 'co2e', 'points', 'friends', 'games'
...
CREATE TABLE IF NOT EXISTS game_scores (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  user_wallet TEXT NOT NULL,
  game_type TEXT NOT NULL, -- 'charging_race', 'forest_builder', 'energy_quiz'
